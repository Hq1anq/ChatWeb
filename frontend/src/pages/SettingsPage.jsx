    ...
    <div className="min-h-screen bg-base-200 p-4 md:p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="card w-full bg-error/10 border border-error shadow-xl">
          <div className="card-body">
            <h2 className="card-title text-2xl mb-4 text-error">Khu vực nguy hiểm</h2>
            <p>Các hành động sau đây không thể hoàn tác. Xin hãy cẩn thận.</p>
            <div className="card-actions justify-between items-center mt-4">
              <span className="font-medium">Xoá tài khoản của bạn vĩnh viễn.</span>
              <button className="btn btn-error btn-outline" onClick={openDeleteModal}>
      ...
      <dialog id="delete_account_modal" className="modal">
        <div className="modal-box">
          ...
          <p className="py-4">
            Hành động này không thể hoàn tác. Toàn bộ dữ liệu của bạn, bao gồm các
            cuộc trò chuyện và thông tin cá nhân, sẽ bị xoá vĩnh viễn.
          </p>
          <p>Vui lòng nhập <strong className="text-error">xoá tài khoản</strong> để xác nhận.</p>
          <input
            type="text"
